...
public class AtributPengeluaranBulanan {
    ...
    private int bulan_pengeluaran;

    public AtributPengeluaranBulanan() {
    }

    public AtributPengeluaranBulanan(String id_pengeluaran_bulanan, String nama_kebutuhan_bulanan, int nominal_pengeluaran_bulanan, String batas_waktu_pembayaran, String jenis_pengeluaran, int bulan_pengeluaran) {
    ...
    public int getBulan_pengeluaran() {
        return bulan_pengeluaran;
    }

    public void setBulan_pengeluaran(int bulan_pengeluaran) {
        this.bulan_pengeluaran = bulan_pengeluaran;
    }
}
